...
$lrnid=$_POST['lrnid'];
$classid=$_POST['class'];
$_SESSION['lrnid']=$lrnid;
$_SESSION['classid']=$classid;
$qery = "SELECT   tblstudents.StudentName,tblstudents.LrnId,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblclasses.ClassName,tblclasses.Section from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.LrnId=:lrnid and tblstudents.ClassId=:classid ";
$stmt = $dbh->prepare($qery);
$stmt->bindParam(':lrnid',$lrnid,PDO::PARAM_STR);
...
<p><b>Student Lrn Id :</b> <?php echo htmlentities($row->LrnId);?>
...
// Code for result
 ...
 $query ="select t.StudentName,t.LrnId,t.ClassId,t.marks,SubjectId,tblsubjects.SubjectName from (select sts.StudentName,sts.LrnId,sts.ClassId,tr.marks,SubjectId from tblstudents as sts join  tblresult as tr on tr.StudentId=sts.StudentId) as t join tblsubjects on tblsubjects.SubjectId=t.SubjectId where (t.LrnId=:lrnid and t.ClassId=:classid)";
$query= $dbh -> prepare($query);
$query->bindParam(':lrnid',$lrnid,PDO::PARAM_STR);
...
<?php
echo htmlentities("Invalid Lrn Id");
 }
?>
                                        </div>
