...
$dob=$_POST['dob']; 
$status=$_POST['status'];
$sql="update tblstudents set StudentName=:studentname,LrnId=:lrnid,StudentEmail=:studentemail,Gender=:gender,DOB=:dob,Status=:status where StudentId=:stid ";
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Lrn Id</label>
<div class="col-sm-10">
<input type="text" name="lrnid" class="form-control" id="lrnid" value="<?php echo htmlentities($result->LrnId)?>" maxlength="12" required="required" autocomplete="off">
</div
</div>
